...
// p3: Assassin
//
// AssasinMAin.java Instructor-provided testing program.
...
public class AssassinMain {
   ...
   public static final String KILL_LIST_FILENAME = "killOrder.txt";
    ...
    public static final int SEED = (int) System.currentTimeMillis(); // or 42;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        AssassinManager manager = new AssassinManager(nameList);
         ...
         Scanner console; // to get names to kill next
         if(AUTO_KILL) {
           console = new Scanner(new FileReader(KILL_LIST_FILENAME));      
         } else {
           console = new Scanner(System.in);
         }
         while (!manager.isGameOver()) { /*get next victims until game ends */
